...
{
    public partial class saderet : Form
    {
        int _bc, _mc,_yc;
        public saderet(int bc,int mc,int yc)
        {
            InitializeComponent();
            _bc=bc;
            _mc= mc;
        ...
        private void saderet_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'MyDataSet.sader' table. You can move, or remove it, as needed.
            this.saderTableAdapter.Fill(this.MyDataSet.sader,_bc,_mc,_yc);
